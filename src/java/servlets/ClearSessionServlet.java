...
public class ClearSessionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(usernameFromSession != null){
            ...
            if(menuManager.isInLoby())
                gameSettingsManager.getGameSettings().getPlayerNames().remove(usernameFromSession);
        }
        if(userManager.getUsers().isEmpty() || !menuManager.isInLoby())
